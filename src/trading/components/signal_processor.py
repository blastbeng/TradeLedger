...
class SignalProcessor:
    ...
    async def check_pause_resume_decision(self) -> None:
        ...
        async with engine._symbol_reeval_lock:
            ...
            pause_resume_complexity = self.model_tier_manager.compute_prompt_complexity(
                num_candidates=0,
            ...
            effective_temp = self.model_tier_manager._get_effective_temperature("actuator", pause_resume_complexity)
