...
"""
    ...
    if historical_ohlcv:
        ...
        prompt += (
            ...
            "**if the trend is up (close > EMA50) AND the trend is strong (ADX > 20)**. Your goal is to find parameters that would have been profitable "
            "*given* this entry logic. This means the parameters must be able to capture strong trends and cut losses "
