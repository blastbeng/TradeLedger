                ...
                if summary and summary.get("model_type"):
                    ...
                    if llm_provider and llm_model:
                        ...
                        if model == "mind":
                            ...
                            provider_name = settings.LLM_SENTIMENT_PROVIDER or settings.LLM_PROVIDER
                            if provider_name == "ollama":
                                model_name = settings.OLLAMA_SENTIMENT_MODEL
                            elif provider_name == "g4f":
                                from src.llm.g4f_client import _get_g4f_models
                                model_name = _get_g4f_models("sentiment")
                            else:
                                model_name = settings.OPENAI_SENTIMENT_MODEL
                        else:
                    ...
                    # Settings models are lists, join them into a clean string
                    if isinstance(model_name, list):
                        model_name = ", ".join(model_name) if model_name else "N/A"
